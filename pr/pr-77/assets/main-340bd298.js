...
`;let se=class extends C{constructor(){super(...arguments),this.config=new $}render(){return m`
    ...
    `}};k([V({type:String,reflect:!0})],I.prototype,"mode",void 0);k([V({type:Object})],I.prototype,"customModalContent",void 0);k([V({type:Object})],I.prototype,"hostBridge",void 0);k([We("modal-template")],I.prototype,"modalTemplate",void 0);I=k([Se("modal-manager")],I);ke(m`
        <modal-manager>
