 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */var ge;((ge=window.HTMLSlotElement)===null||ge===void 0?void 0:ge.prototype.assignedElements)!=null;const It=Object.freeze({processing:"processing",complete:"complete"});class Nt extends C{static get properties(){return{mode:{type:String}}}constructor(){super(),this.mode=It.processing}render(){return g`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
...
`;class Ot extends C{static get styles(){return p`
      :host {
    ...
    `}render(){return Bt}}customElements.define("ia-icon-close",Ot);const Rt=g`
<svg
  class="ia-logo"
  viewBox="0 0 27 30"
  xmlns="http://www.w3.org/2000/svg"
...
`;let Ae=class extends C{constructor(){super(...arguments),this.config=new y}render(){return g`
    ...
    `}static get styles(){const e=p`var(--modalLogoSize, 6.5rem)`,t=p`var(--processingImageSize, 7.5rem)`,i=p`var(--modalCornerRadius, 1rem)`,o=p`var(--modalBorder, 2px solid black)`,n=p`var(--modalBottomMargin, 2.5rem)`,r=p`var(--modalTopMargin, 5rem)`,d=p`var(--modalHeaderBottomPadding, 0.5em)`,l=p`var(--modalBottomPadding, 2rem)`,a=p`var(--modalScrollOffset, 5px)`,c=p`var(--modalTitleFontSize, 1.8rem)`,u=p`var(--modalSubtitleFontSize, 1.4rem)`,h=p`var(--modalHeadlineFontSize, 1.6rem)`,m=p`var(--modalMessageFontSize, 1.4rem)`,w=p`var(--modalTitleLineHeight, normal)`,_=p`var(--modalSubtitleLineHeight, normal)`,I=p`var(--modalHeadlineLineHeight, normal)`,N=p`var(--modalMessageLineHeight, normal)`;return p`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
    ...
    `}};P([ne({type:Object})],Ae.prototype,"config",void 0);Ae=P([nt("modal-template")],Ae);function Ut(s,e,t){var i=t||{},o=i.noTrailing,n=o===void 0?!1:o,r=i.noLeading,d=r===void 0?!1:r,l=i.debounceMode,a=l===void 0?void 0:l,c,u=!1,h=0;function m(){c&&clearTimeout(c)}function w(I){var N=I||{},M=N.upcomingOnly,re=M===void 0?!1:M;m(),u=!re}function _(){for(var I=arguments.length,N=new Array(I),M=0;M<I;M++)N[M]=arguments[M];var re=this,we=Date.now()-h;if(u)return;function X(){h=Date.now(),e.apply(re,N)}function Me(){c=void 0}!d&&a&&!c&&X(),m(),a===void 0&&we>s?d?(h=Date.now(),n||(c=setTimeout(a?Me:X,s))):X():n!==!0&&(c=setTimeout(a?Me:X,a===void 0?s-we:s))}return _.cancel=w,_}var E;(function(s){s.Open="open",s.Closed="closed"})(E||(E={}));class qt{constructor(e){this.windowResizeThrottler=Ut(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case E.Open:this.startResizeListener(),this.stopDocumentScroll();break;case E.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let z=class extends C{constructor(){super(...arguments),this.mode=E.Closed,this.hostBridge=new qt(this),this.closeOnBackdropClick=!0}render(){return g`
      <div class="container">
