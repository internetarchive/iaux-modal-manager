...
`;let ne=class extends w{constructor(){super(...arguments),this.config=new b}render(){return m`
    ...
    `}};k([Z({type:Object})],ne.prototype,"config",void 0);ne=k([Oe("modal-template")],ne);function dt(i,e,t){var o=t||{},s=o.noTrailing,n=s===void 0?!1:s,r=o.noLeading,c=r===void 0?!1:r,l=o.debounceMode,a=l===void 0?void 0:l,d,u=!1,p=0;function f(){d&&clearTimeout(d)}function I(S){var E=S||{},C=E.upcomingOnly,K=C===void 0?!1:C;f(),u=!K}function $(){for(var S=arguments.length,E=new Array(S),C=0;C<S;C++)E[C]=arguments[C];var K=this,ce=Date.now()-p;if(u)return;function z(){p=Date.now(),e.apply(K,E)}function de(){d=void 0}!c&&a&&!d&&z(),f(),a===void 0&&ce>i?c?(p=Date.now(),n||(d=setTimeout(a?de:z,i))):z():n!==!0&&(d=setTimeout(a?de:z,a===void 0?i-ce:i))}return $.cancel=I,$}var M;(function(i){i.Open="open",i.Closed="closed"})(M||(M={}));class ut{constructor(e){this.windowResizeThrottler=dt(100,this.updateModalContainerHeight,{noLeading:!1,noTrailing:!1}).bind(this),this.modalManager=e}handleModeChange(e){switch(e){case M.Open:this.startResizeListener(),this.stopDocumentScroll();break;case M.Closed:this.stopResizeListener(),this.resumeDocumentScroll();break}}updateModalContainerHeight(){this.modalManager.style.setProperty("--containerHeight",`${window.innerHeight}px`)}stopDocumentScroll(){document.body.classList.add("modal-manager-open")}resumeDocumentScroll(){document.body.classList.remove("modal-manager-open")}startResizeListener(){window.addEventListener("resize",this.windowResizeThrottler)}stopResizeListener(){window.removeEventListener("resize",this.windowResizeThrottler)}}let H=class extends w{constructor(){super(...arguments),this.mode=M.Closed,this.hostBridge=new ut(this),this.modal=new st(this),this.closeOnBackdropClick=!0}firstUpdated(){return Ae(this,void 0,void 0,function*(){yield new Promise(e=>setTimeout(e,0))})}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate()}render(){return m`
      <div class="container">
    ...
    `}};k([Z({type:String,reflect:!0})],H.prototype,"mode",void 0);k([Z({type:Object})],H.prototype,"customModalContent",void 0);k([Z({type:Object})],H.prototype,"hostBridge",void 0);k([Ge("modal-template")],H.prototype,"modalTemplate",void 0);H=k([Oe("modal-manager")],H);Pe(m`
